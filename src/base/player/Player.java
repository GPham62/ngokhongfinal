...
//        this.renderer = new RotateRenderer(SpriteUtils.loadImage("assets/images/enemies/level0/black/0.png"));
        ...
        SmokeEffect smokeEffect1 = GameObject.recycle(SmokeEffect.class);
        smokeEffect1.position.set(this.position);
        SmokeEffect smokeEffect2 = GameObject.recycle(SmokeEffect.class);
        smokeEffect2.position.set(this.position);
        SmokeEffect smokeEffect3 = GameObject.recycle(SmokeEffect.class);
        smokeEffect3.position.set(this.position);
        SmokeEffect smokeEffect4 = GameObject.recycle(SmokeEffect.class);
        smokeEffect4.position.set(this.position);
        SmokeEffect smokeEffect5 = GameObject.recycle(SmokeEffect.class);
        smokeEffect5.position.set(this.position);
        SmokeEffect smokeEffect6 = GameObject.recycle(SmokeEffect.class);
        smokeEffect6.position.set(this.position);
        this.createRenderer();
